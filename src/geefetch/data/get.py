...
def download_landsat7(
    ...
    """Download Landsat 7 images. Images are written in several .tif chips
    to `data_dir`. Additionally, a file `landsat7.vrt` is written to combine all the chips.
...
def download_landsat5(
    ...
    """Download Landsat 5 images. Images are written in several .tif chips
    to `data_dir`. Additionally, a file `landsat8.vrt` is written to combine all the chips.
